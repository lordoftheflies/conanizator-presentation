"""
Django settings for dopamin_demo project.
...
SECRET_KEY = '+y23d@j=s6$2+w@x5@e7@&m#ur1$l*5hrt!y@9k#(7+69613tw'
...
ROOT_URLCONF = 'dopamin_presentation_demo.urls'
...
WSGI_APPLICATION = 'dopamin_presentation_demo.wsgi.application'
...
# STATICFILES_DIRS = [
#     # os.path.join(BASE_DIR, 'dopamin_presentation', 'static'),
#     # '/var/www/static/',
# ]
STATICFILES_FINDERS = [
